...
<head>
    <meta charset="utf-8">
    <title>Daftar Pelamar - Kejora</title>
                    ...
                    <div class="col-lg-6 col-md-8">
                        ...
                        <div class="auth-card">
                            <div class="auth-header text-center mb-4">
                                <span class="badge bg-primary rounded-pill mb-2 px-3 py-2">Pencari Kerja</span>
                                <h2>Buat Akun Baru</h2>
                                <p>Temukan karir impianmu di sini.</p>
                            </div>
                            ...
                            <form class="auth-form">
                                ...
                                <div>
                                    ...
                                    <input type="password" class="form-control" placeholder="Buat sandi baru">
                                </div>
                                
                                <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-bold mt-3 shadow-sm">Daftar Sekarang</button>
                            </form>
